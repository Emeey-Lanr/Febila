  ...
  return (
    <div className="py-10">
      <div className="w-4/5 mx-auto py-4">
        <h1 className="text-4xl text-blue-600 leading-10">Contact</h1>
      ...
      <div className="w-4/5 mx-auto">
        <form className="w-full" onSubmit={formik.handleSubmit}>
          ...
          <div className="flex justify-between items-center sm:block">
            <div className="w-5/12 my-1 sm:w-full">
              <label className="py-1 text-sm text-gray-600">Phone Number</label>
              <br />
              <input
                type="number"
                onChange={formik.handleChange}
          ...
          <div className="flex justify-end">
            <button
              disabled={btnStatus}
              type="submit"
              className="h-10 w-32 flex justify-center items-center bg-blue-600 text-sm text-white rounded-full sm:w-full"
            >
